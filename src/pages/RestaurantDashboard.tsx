      ...
      <div className="w-full pt-6 sm:pt-10 px-4 sm:px-6 lg:px-8 xl:px-16 2xl:px-24 pb-24">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-12 gap-10">
          ...
          <div className="xl:col-span-5 space-y-4 sm:space-y-5">
            <div className="bg-white p-4 sm:p-6 rounded-3xl sm:rounded-4xl border border-slate-100 shadow-sm min-h-100 sm:min-h-140 flex flex-col">
              {/* Header */}
              <div className="flex items-center justify-between mb-5 sm:mb-6">
                ...
                <span className="bg-indigo-50 text-indigo-700 text-[9px] sm:text-[10px] font-bold px-3 py-1 rounded-full uppercase tracking-wider border border-indigo-100">
