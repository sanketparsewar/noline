      ...
      <div className="max-w-7xl mx-auto pt-6 sm:pt-10 px-4 sm:px-6 lg:px-8 pb-24">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-12 gap-10">
          ...
          <div className="xl:col-span-5 space-y-6">
            <div className="bg-white p-5 sm:p-8 rounded-4xl sm:rounded-[2.5rem] border border-slate-100 shadow-sm min-h-100 sm:min-h-150 flex flex-col">
                    ...
                    >
                      ...
                      <div className="flex items-center gap-1 sm:gap-3 shrink-0 relative z-10">
                        <button
                          ...
                          className="p-2 sm:p-3 text-slate-400 hover:text-red-500 hover:bg-red-50 rounded-2xl transition-all"
                        ...
                        {entry.status === "waiting" ? (
                          <button
                            ...
                            className="bg-indigo-600 text-white px-4 sm:px-8 py-2.5 sm:py-3.5 rounded-xl sm:rounded-2xl text-xs sm:text-sm font-black hover:bg-indigo-700 transition-all shadow-lg shadow-indigo-100 active:scale-95 whitespace-nowrap"
                          >
                            Call
                          </button>
                        ) : (
                          <button
                            ...
                            className="bg-green-600 text-white px-4 sm:px-8 py-2.5 sm:py-3.5 rounded-xl sm:rounded-2xl text-xs sm:text-sm font-black hover:bg-green-700 transition-all shadow-lg shadow-green-100 flex items-center gap-1.5 sm:gap-2 active:scale-95 whitespace-nowrap"
                          >
                            <CheckCircle2 className="w-3.5 h-3.5 sm:w-4" />{" "}
                            Done
                          </button>
                        )}
                      </div>
